...
import com.thatcherbm.gasmileagetracker.dummy.DummyContent;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switch (position) {
                        default:
                        case 0: // vehicles
                            Intent vIntent = new Intent(PageListActivity.this, ViewVehicles.class);
                            startActivity(vIntent);
                            break;
                        case 1: // fillups
                            Intent fIntent = new Intent(PageListActivity.this, ViewFillups.class);
                            startActivity(fIntent);
                            break;
                        case 2: // reports
                            Intent rIntent = new Intent(PageListActivity.this, ViewReports.class);
